...
import { BacklinksFilterPresets } from "./BacklinksFilterPresets";
import { DisavowExportButton } from "./DisavowExportButton";
...
export function BacklinksResultsCard({
  ...
  exportTarget: string;
  /** Overview totals: grouped views must say how many links sit behind the
   * domain count, or trust in the numbers dies. */
  summary?: {
